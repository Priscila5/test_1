# The name of this view in Looker is "Compras Internacionales Eu"
view: compras_internacionales_eu {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `mercadoseeuuvschina100.Compras_internacionales_EU` ;;
